...
from app.schemas.user import UserCreate, UserOut, RoleCreate, PermissionCreate
from app.crud.user import create_user, get_all_users, get_user_details, delete_user, create_role, create_permission
...
async def create_user(data: UserCreate,  db: AsyncSession = Depends(get_async_session)):
    try:
        ...
        return await create_user(db, data, file_path);
